...
// Shotgun Shells
            <div className="search-result-item">
                ...
                <div className="content-dropdown">
                    <div className="content-dropdown-title" onClick={ () => { ToggleDropdown(document.getElementById("shotgun-shells-dropdown-1-caret")!, document.getElementById("shotgun-shells-dropdown-1")!) } }>
                        <p>Compulsory if the <span className="defender special-text">DEFENDER</span> has a REF lower than 8 (0 - 7)</p>
                ...
                <div className="information-divider"></div>
                <div className="content-dropdown">
                    <div className="content-dropdown-title" onClick={ () => { ToggleDropdown(document.getElementById("shotgun-shells-dropdown-2-caret")!, document.getElementById("shotgun-shells-dropdown-2")!) } }>
                        <p>(Optional) If the <span className="defender special-text">DEFENDER</span> has a REF of 8 or higher</p>
...
// Explosives
            <div className="search-result-item">
                ...
                <div className="content-dropdown">
                    <div className="content-dropdown-title" onClick={ () => { ToggleDropdown(document.getElementById("explosives-dropdown-1-caret")!, document.getElementById("explosives-dropdown-1")!) } }>
                        <p>Compulsory if the <span className="defender special-text">DEFENDER</span> has a REF lower than 8 (0 - 7)</p>
                ...
                <div className="information-divider"></div>
                <div className="content-dropdown">
                    <div className="content-dropdown-title" onClick={ () => { ToggleDropdown(document.getElementById("explosives-dropdown-2-caret")!, document.getElementById("explosives-dropdown-2")!) } }>
                        <p>(Optional) If the <span className="defender special-text">DEFENDER</span> has a REF of 8 or higher</p>
